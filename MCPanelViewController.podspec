Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/matthewcheok/MCPanelViewController'
  s.author   = { 'Matthew Cheok' => 'cheok.jz@gmail.com' }
  s.requires_arc = true
  s.source   = { :git => 'https://github.com/matthewcheok/MCPanelViewController.git', :branch => 'master', :tag => s.version.to_s }
